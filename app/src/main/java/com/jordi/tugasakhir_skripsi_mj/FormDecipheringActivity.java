...
public class FormDecipheringActivity extends AppCompatActivity {

    private Button btn_InputFile, btn_Decrypt;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_form_deciphering);

        btn_InputFile = findViewById(R.id.btn_inFile);
        btn_Decrypt = findViewById(R.id.btn_Deciphering);
        ...
        progressDialog = new ProgressDialog(FormDecipheringActivity.this);
        progressDialog.setTitle("Deciphering");
        progressDialog.setMessage("Harap Tunggu, Sedang melakukan dekripsi");
                        ...
                        new Thread(new Runnable() {
                            ...
                            public void run() {
                                try {
                                    ...
                                    String filename = "Decrypted - " + edt_InputFileName.getText().toString() + ".mp4";
                                    ...
                                    //Proses Dekripsi.
                                    Deciphering dcp = new Deciphering();
                                    dcp.decipher(is, bytesKey, myExternalFile);
                                        ...
                                        runOnUiThread(new Runnable() {
                                            ...
                                            public void run() {
                                                ...
                                                Toast.makeText(getApplicationContext(), "Saved to " + getFilesDir() + "/" +
                                                        "Decrypted - " + edt_InputFileName.getText().toString() + ".mp4", Toast.LENGTH_LONG).show();
